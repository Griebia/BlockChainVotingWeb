package com.blockchainvotingweb.data.generator;

import com.blockchainvotingweb.data.Role;
import com.blockchainvotingweb.data.entity.SamplePerson;
import com.blockchainvotingweb.data.entity.User;
import com.blockchainvotingweb.data.service.SamplePersonRepository;
import com.blockchainvotingweb.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 12, 13, 0, 0, 0));
