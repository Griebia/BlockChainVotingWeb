...
@RolesAllowed("admin")
@Uses(Icon.class)
public class AddcandidateView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "empty/%d/edit";
    ...
    public AddcandidateView(@Autowired SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("addcandidate-view", "flex", "flex-col", "h-full");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AddcandidateView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AddcandidateView.class);
            }
        }
    }
